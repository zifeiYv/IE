...
parser.add_argument("--model_path", required=True, help="Directory to an offline model")
parser.add_argument("--tokenizer_path", required=True, help="Directory to tokenizer path")
...
def do_predict():
    ...
    # Loads pretrained model ERNIE
    model = ErnieForTokenClassification.from_pretrained(
        args.model_path, num_classes=num_classes)
