...
parser.add_argument("--model_name_or_path", type=str, required=True, help="Path to pre-trained model or shortcut name selected in the list: " + ", ".join(list(BertTokenizer.pretrained_init_configuration.keys())))
...
parser.add_argument("--train_data_file", required=True, help="Absolute path to annotated data used for train.")
...
def do_train(args):
    ...
    train_ds = CustomDatasetBuilder(lazy=False, file_mode=args.file_mode).read_datasets(data_files=args.train_data_file)
